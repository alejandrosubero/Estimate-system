...
public class TemplatePojo  {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TemplatePojo)) return false;
        TemplatePojo that = (TemplatePojo) o;
        return active == that.active && Objects.equals(idTemplete, that.idTemplete) && Objects.equals(template, that.template) && Objects.equals(descripcion, that.descripcion) && Objects.equals(tipo, that.tipo) && Objects.equals(codeTemplate, that.codeTemplate);
    }
