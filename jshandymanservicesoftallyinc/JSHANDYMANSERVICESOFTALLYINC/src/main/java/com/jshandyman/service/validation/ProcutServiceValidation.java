...
@Service
public class ProcutServiceValidation {

    public ProcutServicePojo valida(ProcutServicePojo procutservice) {
        ProcutServicePojo pojo = null;
        try {
            if (procutservice != null) {
                if (procutservice.getTypeservice() != null) {
                    pojo = procutservice;
                }
            }
            return pojo;
