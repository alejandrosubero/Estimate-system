...
public class Parameters extends Auditable{
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(idParametee, that.idParametee) && Objects.equals(clave, that.clave) && Objects.equals(valor, that.valor) && Objects.equals(description, that.description) && Objects.equals(nota, that.nota) && Objects.equals(activo, that.activo) && Objects.equals(company, that.company);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), idParametee, clave, valor, description, nota, activo, company);
    }
}
