...
public class PaymentValidation {
    ...
    public PaymentPojo valida(PaymentPojo payment) {
        PaymentPojo pojo = null;
        try {
            if (payment != null) {
                if ( payment.getPayday() != null && payment.getTypePayment() != null &&
                        payment.getAmountPaind() != null && payment.getBillNumberAsociate() != null) {
                    pojo = payment;
                }
            }
            return pojo;
