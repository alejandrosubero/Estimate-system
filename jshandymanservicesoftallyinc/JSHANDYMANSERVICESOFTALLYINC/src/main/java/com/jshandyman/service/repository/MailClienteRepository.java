...
public interface MailClienteRepository extends CrudRepository< MailCliente, Long> {
 
		public Optional<MailCliente> findByEmail(String email);
		public List<MailCliente> findByEmailContaining(String email);
		public Optional<MailCliente> findByCodeClient(String codeClient);
