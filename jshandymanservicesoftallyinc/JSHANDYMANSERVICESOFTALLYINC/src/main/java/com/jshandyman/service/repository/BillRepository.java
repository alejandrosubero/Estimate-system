...
public interface BillRepository extends CrudRepository< Bill, Long> {
		...
		public Optional<Bill> findByBillType(String billType);
		...
		public Optional<Bill> findByBillTotalWichoutTaxes(Double billTotalWichoutTaxes);
		public List<Bill> findByBillTotalWichoutTaxesContaining(Double billTotalWichoutTaxes);
		public Optional<Bill> findByBillTotal(Double billTotal);
